          ...
          <ModalBody>
            {selectedRegistration && (
                <Box>
                  ...
                  <Text><b>Website:</b> {selectedRegistration.website || "N/A"}</Text>
                  ...
                  {/* Initiated Letters — generated via the Initiate Letters
                      page (Letter of Invitation / Warning Letter); staff and
                      superadmin can both view, generate, and edit these. */}
                  {user.role !== 'guest' && selectedRegistration.generatedLetters && selectedRegistration.generatedLetters.length > 0 && (
                    <Box mt={4}>
                      ...
                      {selectedRegistration.generatedLetters.map((gl) => (
                        <Flex key={gl._id} p={2} borderWidth="1px" borderRadius="md" mb={2} justify="space-between" align="start" gap={2}>
                          <Box>
                  ...
                  <Table size="sm" variant="simple" borderWidth="1px">
                    ...
                    <Tbody>
                      ...
                      <Tr fontWeight="bold">
                        ...
                        <Td isNumeric whiteSpace="nowrap">₦{violation.amountSanctioned?.toLocaleString()}.00</Td>
                      </Tr>
                    </Tbody>
                  </Table>
                </Box>
